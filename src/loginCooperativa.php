...
<head>
    ...
    <script>
        ...
        <?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true): ?>
            window.location.href = "../views/site.php";
        <?php endif; ?>
    </script>
</head>
<body> 
    <main>
        <div class="login-container">
            <div class="form-container">
                ...
                <!--tela login da cooperativa-->
                <form action="controllers/loginCoopController.php" method="post" class="form form-login">
                    <h2 class="form-title">Acesse sua conta</h2>
                    <div class="form-input-container">
                        <input type="text" name="user" class="form-input" placeholder="Usuário" required>
